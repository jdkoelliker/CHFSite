...
import django
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "CHFSite.settings")
django.setup()
...
for i in range(1, 10):
  ...
  u.Address1 = 'Address1%i' % i
  u.Address2 = 'Address2%i' % i
  u.City = 'City%i' % i
  u.BirthDate = datetime.datetime.now()
  u.Phone = '555-555-000%i' % i
  u.is_active = True
  if i == 1:
    u.is_staff = True
    u.is_superuser = True
