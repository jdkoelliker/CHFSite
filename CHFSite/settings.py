"""
Django settings for CHFSite project.
...
SECRET_KEY = 'w@l@cf^6@t#xww4hi+ifedvk%&q@yrgqspie+6_#+ls^vxr!jf'
...
WSGI_APPLICATION = 'CHFSite.wsgi.application'
